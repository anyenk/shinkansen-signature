...
describe('verifySignature', () => {
  ...
  const mockJws = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJQUzI1NiIsIng1YyI6WyJNSUlDZXJ0aWZpY2F0ZURhdGEuLi4iXX0.eyJhbW91bnQiOjEwMDAsImN1cnJlbmN5IjoiVVNEIn0.signature';
  ...
  it('should reject untrusted certificate', async () => {
    const options: VerifySignatureOptions = {
      jws: mockJws,
      payload: mockPayload,
      trustedCertificates: ['different-certificate']
    };
